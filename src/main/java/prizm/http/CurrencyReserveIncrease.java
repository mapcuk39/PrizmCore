 ...
 * Constraints
 * <p>
 * This API is allowed only when the currency is {@link prizm.CurrencyType#RESERVABLE} and is not yet active.
 * <p>
 ...
 * The list of founders and their NQT investment can be obtained using the {@link prizm.http.GetCurrencyFounders} API.
 */
