 ...
 * For {@link prizm.CurrencyType#RESERVABLE} currency
 ...
 * For {@link prizm.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link prizm.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link prizm.crypto.HashFunction algorithm} used for minting.
 * For {@link prizm.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link prizm.CurrencyType#EXCHANGEABLE} nor {@link prizm.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link prizm.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link prizm.CurrencyType#RESERVABLE} becomes active, in case it is {@link prizm.CurrencyType#CLAIMABLE} the NXT used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link prizm.CurrencyType#RESERVABLE} becomes active, in case it is non {@link prizm.CurrencyType#CLAIMABLE} the NXT used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link prizm.CurrencyType#MINTABLE} currency, the number of units per {@link prizm.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link prizm.http.CurrencyMint}<br>
 * </ul>
 *
 * @see prizm.CurrencyType
 * @see prizm.crypto.HashFunction
 */
