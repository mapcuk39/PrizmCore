...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header1 =
            ...
            "               <li><a href='https://wikiforApi' target='_blank' style='margin-left:20px;'>Wiki Docs</a></li>\n" +
            "           </ul>\n" +
            "       </div>\n" +
            "   </div>\n" +
            "</div>\n" +
    ...
    private static String form(HttpServletRequest req, String requestType, boolean singleView, APIServlet.APIRequestHandler requestHandler) {
        ...
        buf.append("<a style='font-weight:normal;font-size:14px;color:#777;' href='https://wikiforapi#");
        ...
        buf.append("<form action='/prizm' method='POST' ");
