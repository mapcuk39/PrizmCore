...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = Prizm.getIntProperty("prizm.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = Prizm.getBlockchain().getHeight() + 720;
    ...
    private volatile PrizmException.NotCurrentlyValidException failureCause;
    ...
    public PrizmException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            Transaction.Builder builder = Prizm.newTransactionBuilder(Crypto.getPublicKey(secretPhrase), 0, 0,
                    (short) 1440, attachment);
            builder.timestamp(Prizm.getBlockchain().getLastBlockTimestamp());
            ...
            if (participantAccount == null || transaction.getFeeNQT() > participantAccount.getUnconfirmedBalanceNQT()) {
                ...
                failureCause = new PrizmException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends PrizmException {
